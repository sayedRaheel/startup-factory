...
export async function generateFingerprint(commitHistory: string[], fileList: string[]): Promise<string> {
...
export async function reviewDiff(diff: string, fingerprint: string): Promise<string> {
